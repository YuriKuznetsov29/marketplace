...
import { CreateChat } from '../../../features/messenger/ui/create-chat'
...
export const ListingDetail: React.FC<ListingDetailProps> = async ({ listing }) => {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                    ...
                    <Card>
                        ...
                        {session?.id !== listing.seller.id && (
                            <CreateChat userId1={session?.id} userId2={listing.seller.id} />
                        )}
                    </Card>
                </div>
            </div>
